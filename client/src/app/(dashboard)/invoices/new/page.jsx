    ...
    <div className="max-w-3xl mx-auto">
      ...
      <Card className="p-6 sm:p-8">
        <form onSubmit={submit} className="space-y-5" noValidate>
          ...
          <div className="bg-slate-50 rounded-xl px-5 py-4 space-y-2 text-sm">
            ...
            <div className="flex justify-between pt-2 border-t border-slate-200 font-bold text-slate-900"><span>Total</span><span className="text-blue-600">{formatINR(total)}</span></div>
          </div>
